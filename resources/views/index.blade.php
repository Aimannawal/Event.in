                ...
                <div class="swiper-slide relative w-full h-full">
                    ...
                    <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
                        <div class="text-center text-white px-4">
                            ...
                            <a href="#"
                                class="bg-[#EB8317] text-white px-8 py-3 rounded-full text-lg font-medium hover:bg-[#d67615] transition duration-300">Explore
                                Events</a>
                        </div>
                    </div>
                </div>
                <div class="swiper-slide relative w-full h-full">
                    ...
                    <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
                        <div class="text-center text-white px-4">
                            ...
                            <a href="#"
                                class="bg-[#EB8317] text-white px-8 py-3 rounded-full text-lg font-medium hover:bg-[#d67615] transition duration-300">Start
                                Planning</a>
                        </div>
                    </div>
                </div>
                <div class="swiper-slide relative w-full h-full">
                    ...
                    <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
                        <div class="text-center text-white px-4">
                            ...
                            <a href="#"
                                class="bg-[#EB8317] text-white px-8 py-3 rounded-full text-lg font-medium hover:bg-[#d67615] transition duration-300">Join
                                Now</a>
                        </div>
                    </div>
                </div>
    ...
    <div class="container mx-auto px-4 py-12">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
            <a href="#"
                ...
                <h3 class="text-xl font-medium">Music</h3>
            </a>
            <a href="#"
                class="bg-gray-100 rounded-lg p-6 text-center hover:bg-[#EB8317] hover:text-white transition duration-300 transform hover:scale-105">
                <svg class="w-8 h-8 mx-auto mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <h3 class="text-xl font-medium">Sports</h3>
            </a>
            <a href="#"
                class="bg-gray-100 rounded-lg p-6 text-center hover:bg-[#EB8317] hover:text-white transition duration-300 transform hover:scale-105">
                <svg class="w-8 h-8 mx-auto mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <h3 class="text-xl font-medium">Arts</h3>
            </a>
            <a href="#"
                class="bg-gray-100 rounded-lg p-6 text-center hover:bg-[#EB8317] hover:text-white transition duration-300 transform hover:scale-105">
                <svg class="w-8 h-8 mx-auto mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <h3 class="text-xl font-medium">Food</h3>
            </a>
            <a href="#"
                class="bg-gray-100 rounded-lg p-6 text-center hover:bg-[#EB8317] hover:text-white transition duration-300 transform hover:scale-105">
                <svg class="w-8 h-8 mx-auto mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <h3 class="text-xl font-medium">Technology</h3>
            </a>
            <a href="#"
                class="bg-gray-100 rounded-lg p-6 text-center hover:bg-[#EB8317] hover:text-white transition duration-300 transform hover:scale-105">
                <svg class="w-8 h-8 mx-auto mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="#"
                ...
                <h3 class="text-xl font-medium">Lifestyle</h3>
            </a>
            <a href="#"
                class="bg-gray-100 rounded-lg p-6 text-center hover:bg-[#EB8317] hover:text-white transition duration-300 transform hover:scale-105">
                <svg class="w-8 h-8 mx-auto mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="bg-white rounded-lg shadow-md overflow-hidden">
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <a href="#"
                                    class="bg-[#EB8317] text-white px-4 py-2 rounded-full hover:bg-[#d67615] transition duration-300">Book
                                    Now</a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="max-w-3xl mx-auto">
            ...
            <div class="mb-4 border-b border-gray-200">
                <button
                    class="flex items-center justify-between w-full py-4 text-left transition-colors duration-200 hover:bg-gray-50"
                    onclick="toggleFAQ(this)">
                    <span class="text-lg font-medium">Apakah saya bisa menjual tiket melalui Event.in?</span>
                    <svg class="w-6 h-6 text-gray-500 transition-transform duration-200 ease-in-out" fill="none"
                        stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                    </svg>
                ...
                <div class="overflow-hidden transition-all duration-200 max-h-0 opacity-0">
                    <p class="text-gray-600 p-4">Ya, Anda dapat menjual tiket event melalui platform kami dengan sistem
                        pembayaran yang aman dan terpercaya. Kami menyediakan berbagai metode pembayaran untuk kemudahan
                        pengguna.</p>
                </div>
            </div>
        ...
        <div class="container mx-auto px-4">
            <div class="max-w-3xl mx-auto text-center">
                ...
                <p class="text-xl mb-8">Bergabunglah dengan Event.in dan mulailah merencanakan acara sukses Anda berikutnya
                    hari ini!</p>
                <a href="#"
                    class="bg-white text-[#EB8317] px-8 py-3 rounded-full text-lg font-medium hover:bg-gray-100 transition duration-300 inline-block">Contact
                    Us</a>
            </div>
        </div>
    </div>
